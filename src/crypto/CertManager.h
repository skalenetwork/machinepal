...
public:
    ...
    static void doThoroughKeyCertFormatCheck(const std::filesystem::path& certPath,
...
private:
    ...
    static void validateSSLFiles(const std::filesystem::path& certFile, const std::filesystem::path& keyFile,
