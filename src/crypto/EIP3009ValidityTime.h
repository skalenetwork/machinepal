...
public:
    ...
    friend bool operator!=(const EIP3009ValidityTime& a, const EIP3009ValidityTime& b) { return !(a == b); }
    friend bool operator<(const EIP3009ValidityTime& a, const EIP3009ValidityTime& b) { return a.time_ < b.time_; }
    friend bool operator<=(const EIP3009ValidityTime& a, const EIP3009ValidityTime& b) { return a.time_ <= b.time_; }
    friend bool operator>(const EIP3009ValidityTime& a, const EIP3009ValidityTime& b) { return a.time_ > b.time_; }
    friend bool operator>=(const EIP3009ValidityTime& a, const EIP3009ValidityTime& b) { return a.time_ >= b.time_; }
};
