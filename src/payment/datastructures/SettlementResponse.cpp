...
const std::string& SettlementResponse::transaction() const { return transaction_; }
const std::string& SettlementResponse::network() const { return network_; }
const std::string& SettlementResponse::payer() const { return payer_; }
...
ptr<SettlementResponse> SettlementResponse::getErrorSettlementResponse(HttpError& error, const std::string& network,
                                                                       const std::string& payer)
{
